...
export default function LoginForm() {
  ...
  const handleGoogleSuccess = async (credentialResponse: CredentialResponse) => {
    ...
    try {
      ...
      const redirectUrl = searchParams.get('redirect') || '/';
      router.push(redirectUrl);
    } catch { // <-- CORREÇÃO 1: Variável 'err' removida
      const message = "Não foi possível fazer o login com o Google.";
      setError(message);
      toast.error(message);
    } finally {
      setIsLoading(false);
  ...
  return (
    //       vvvvvvvvvvvvvvvvv <-- CORREÇÃO 2: Classe do Tailwind atualizada
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 flex justify-center">
            <GoogleLogin 
              ...
              onError={() => {
                const message = "Falha no login com Google.";
                setError(message);
                toast.error(message);
              }} 
            />
